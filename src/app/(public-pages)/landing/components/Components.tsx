                ...
                <div className="grid grid-cols-1 lg:grid-cols-8 gap-4">
                    ...
                    >
                        <motion.h2 className="mb-8 max-w-[650px] leading-[1.3] text-5xl">
                            مجموعه غنی از کامپوننت‌های UI را کاوش کنید
                        </motion.h2>
                        <motion.p className="max-w-[600px]">
                            هر کامپوننت با دقت با استفاده از TailwindCSS ساخته شده است، که آن را انعطاف‌پذیر، قابل تنظیم و آسان برای ادغام در پروژه شما با حداقل تنظیمات می‌کند.
                        </motion.p>
                    </motion.div>
