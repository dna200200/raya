            ...
            <Container>
                ...
                >
                    <motion.h2 className="my-6 text-5xl">
                        قدرت Ecme را کشف کنید
                    </motion.h2>
                    <motion.p className="mx-auto max-w-[600px]">
                        طراحی شده برای عملکرد، مقیاس‌پذیری و سهولت استفاده - تجربه یک قالب که برای برآورده کردن تمام نیازهای پروژه شما ساخته شده است
                    </motion.p>
                </motion.div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        به راحتی بین حالت‌های روشن و تاریک جابجا شوید یا تم سفارشی خود را ایجاد کنید.
                                    </p>
                                </div>
                            </Card>
                            <Card
                            ...
                            >
                                ...
                                >
                                    <motion.a
                                        ...
                                        href="https://ecme2.savisapp.ir/guide/documentation/introduction"
                                        target="_blank"
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        راهنماهای گام به گام دقیق برای کمک به شروع کار و تسلط بر قالب.
                                    </p>
                                </div>
                            </Card>
                        </div>
                        <div className="mt-4">
                            ...
                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <p className="mt-2">
                                        از بین گزینه‌های مختلف چیدمان متناسب با نیازهای خود انتخاب کنید. چه عمودی، افقی یا راست به چپ (RTL) باشد، ما انعطاف‌پذیری را برای هر سبک طراحی یا زبان فراهم می‌کنیم.
                                    </p>
                                </div>
                            </Card>
                        </div>
                    ...
                    <div>
                        ...
                        >
                            <div className="flex flex-col justify-between h-full">
                                ...
                                <div className="mt-6">
                                    <h4 className="font-bold">
                                        کامپوننت‌های دست‌ساز Tailwind
                                    </h4>
                                    <p className="mt-2">
                                        مجموعه‌ای از کامپوننت‌های سفارشی و بسیار انعطاف‌پذیر Tailwind که برای هر مورد استفاده مناسب هستند.
                                    </p>
                                </div>
                            </div>
                        </Card>
