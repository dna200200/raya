    ...
    return (
        <Container>
            <div className="text-center mb-8">
                <h2 className="mb-2">آیکون‌های ری‌اکت</h2>
                <p className="max-w-xl mx-auto">
                    ...
                    {` `}شامل بسیاری از مجموعه‌های آیکون محبوب است که از واردات ES6 استفاده می‌کند و به شما اجازه می‌دهد فقط آیکون‌هایی را که استفاده می‌کنید، وارد کنید.
                </p>
            </div>
