...
> = {
    ...
    2: { label: 'ناموفق', dotClass: 'bg-red-500', textClass: 'text-red-500' },
}
        ...
        () => [
            ...
            },
            {
                ...
                cell: (props) => {
                    ...
                    return <span dir='ltr'>{jalaliMoment.unix(parseInt(row.date)).format('jYYYY/jMM/jDD')}</span>
                },
            },
            { header: 'مشتری', accessorKey: 'customer' },
            {
                accessorKey: 'totalAmount',
                header: 'مقدار هزینه شده',
                cell: (props) => {
