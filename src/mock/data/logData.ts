    ...
    },
    {
        ...
        events: [
            ...
            },
            {
                ...
                comment: `<strong>@کارولین</strong> برنامه نویسان برای ایجاد برنامه های ضد احمق بزرگتر و بهتر در حال رقابت با جهان هستند، در حالی که جهان در تلاش است احمق های بزرگتر و بهتری ایجاد کند. تا اینجا کائنات برنده است.`,
            },
            {
                type: 'CREATE-TICKET',
                dateTime: 164625157,
        ...
        events: [
            {
                ...
                userName: 'کامیلا سیمونز',
                userImg: '/img/avatars/thumb-9.jpg',
                comment: `<strong>@کارولین</strong> دو راه برای نوشتن برنامه‌های بدون خطا وجود دارد. فقط سومی کار میکنه`,
            },
            {
                type: 'ADD-FILES-TO-TICKET',
                dateTime: 1646050199,
            ...
            },
            {
                ...
                comment: `<strong>@کارولین</strong> اگر درست کار نکرد نگران نباشید. اگر همه چیز انجام می شد، شما بیکار می شدید.`,
            },
        ],
    },
    {
        ...
        events: [
            ...
            },
            {
                ...
                userName: 'روبرتا هورتون',
                userImg: '/img/avatars/thumb-7.jpg',
                comment: `<strong>@کارولین</strong> این چیزی است که در کار با رایانه جالب است. آنها بحث نمی کنند، همه چیز را به یاد می آورند و تمام آبجو شما را نمی نوشند. (پل لیری) با توجه به وضعیت غم انگیز فعلی برنامه های رایانه ای ما، توسعه نرم افزار به وضوح هنوز یک هنر سیاه است و هنوز نمی توان آن را یک رشته مهندسی نامید.`,
            },
            {
                type: 'UPDATE-TICKET',
                dateTime: 1646491065,
